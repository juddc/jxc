//
// This example does not use the jxc_cpp library at all, only the base jxc library.
// As a result, it's much easier to get fine-grained control over parsing logic,
// at the expense of more boilerplate.
//
// See also web_server_using_converter.cpp for an example of how to use the higher-level
// converter API to reduce boilerplate, at the expense of parsing flexibility.
//
#include <iostream>
#include <string>
#include <sstream>
...
private:
    ...
    LogTarget parse_log_target()
    {
        ...
        {
            throw make_parse_error(jxc::format("Expected logger to be an Object, got {}", jxc::element_type_to_string(parser.value().type)));
        }
...
struct ParsedArgs
{
    fs::path config_path = "./web_server_config_custom_parser.jxc";
