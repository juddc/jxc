...
class OneMonokaiStyle(pygments.style.Style):
    ...
    styles = {
        ...
        pygtoken.Punctuation.Marker:        "#9dc6e8", # class: 'pm'
        ...
        pygtoken.Name.Constant:             "#76c6d9", # class: 'no' - to be revised
