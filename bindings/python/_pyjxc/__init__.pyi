...
class Element:
    ...
    def __init__(self: Element, element_type: ElementType, token: Token, annotation: TokenView): ...
...
class OwnedElement:
    ...
    def __init__(self: OwnedElement, element_type: ElementType, token: Token, annotation: TokenList): ...
...
class Serializer:
    ...
    def value_dict(self: Serializer, arg0: dict) -> Serializer:
        """
    ...
    def value_sequence(self: Serializer, arg0: typing.Sequence) -> Serializer:
        """
...
class TokenList:
    ...
    def append(self: TokenList, arg0: Token): ...
...
class TokenView:
    def __bool__(self: TokenView) -> bool: ...

    def __eq__(self: TokenView, arg0: TokenView) -> bool: ...

    def __ge__(self, rhs: TokenView) -> bool: ...

    def __getitem__(self: TokenView, arg0: int) -> Token: ...

    def __gt__(self, rhs: TokenView) -> bool: ...

    def __hash__(self: TokenView) -> int: ...
    ...
    def __len__(self: TokenView) -> int: ...

    def __lt__(self, rhs: TokenView) -> bool: ...

    def __ne__(self: TokenView, arg0: TokenView) -> bool: ...

    def __repr__(self: TokenView) -> str: ...

    def __setattr__(self, name, value): ...

    def __str__(self: TokenView) -> str: ...

    def copy(self: TokenView) -> TokenList: ...

    def source(self: TokenView) -> str:
        """
        The original text from the buffer that represents all the tokens in this span.
        Primarily useful for accessing the original whitespace.
        """
